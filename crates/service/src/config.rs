...
mod tests {
    use super::{
        automation_rate_capacity, parse_days, parse_paypal_checkout_url,
        refusal_audit_keys_from_env, reject_audit_url_reuse, required_postgres_url,
    ...
    #[test]
    fn for_tests_defaults_paypal_checkout_to_live() {
