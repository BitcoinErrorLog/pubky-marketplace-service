...
/// ends at 0029. Migrations 0001–0026 are never rewritten; this asserts
/// 0029 is the latest additive feature migration.
#[test]
fn migration_catalog_ends_unique_at_0029() {
    ...
    assert_eq!(numbers, expected, "the catalog is 0001..=0029, gapless");
}
